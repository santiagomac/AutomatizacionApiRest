Feature: automatizacion de rest api - pom
  ...
  Scenario: consultar un usuario con metodo get
    ...
    When se consulta en el endpoint "public/v1/users/"  por id "6919898"
  ...
  Scenario: actualiazr un usuario con metodo PUT
    Given se establece la base url "https://gorest.co.in/"
    When se consulta el endpoint "public/v1/users/" por id "6919898" con el metodo PUT con el nombre "Ekaling Prajapat" y el email "ekaling_prajapat@gmail.com"
